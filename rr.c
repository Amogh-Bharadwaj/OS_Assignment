		...
		if (pid1 == 0) {
			...
			if (pid2 == 0) {               
                ...
                while(1){
                    ...
                    if((strcmp(MC1_memory,"Die")==0) && (strcmp(MC2_memory,"Die")==0) && (strcmp(MC3_memory,"Die")==0))break;
                }
            }
        }
    }
